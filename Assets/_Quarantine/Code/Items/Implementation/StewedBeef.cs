...
{
    public class StewedBeef : Item, ISetupItem<FoodItemConfiguration>, IUsableStuff
    {
        ...
        // TODO: change content submesh local position use shader (mask)
        private void ChangeFilling()
        {
            //float fillPercent = (float)System.Math.Round(Durability / _maxDurability, 2);
